...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      motionProgress.current = smoothHero;
  ...
  return <div className={paused ? 'site motion-paused' : 'site'}>
    ...
    <main>
      <section ref={hero} className="hero dimensional-hero" aria-labelledby="hero-title"><div className="hero-stage">
        ...
        <HeroScene paused={paused} progress={motionProgress}/><div className="scene-caption"><span>从想法，到真实界面。</span><span>MOVE TO EXPLORE · SCROLL TO UNFOLD</span></div>

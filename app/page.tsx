    ...
    <main>
      ...
      <section id="experience" className="experience-section">
        ...
        {experience.map((item,index) => <article key={item.company} className={`experience-item experience-${index}`} data-reveal>
          <div className="experience-banner">{index===0 && <div className="loopit-real-covers"><div className="case-glass"><img src="/images/loopit-case-01.webp" alt="案例 01：MyJJKDomain 三卡策略游戏" loading="lazy"/></div><div className="case-glass"><img src="/images/loopit-case-04.webp" alt="案例 04：Emergency Draft 三英雄策略游戏" loading="lazy"/></div><div className="case-glass"><img src="/images/loopit-case-06.webp" alt="案例 06：Spider Sense Online 节奏点击互动" loading="lazy"/></div></div>}<div className="experience-banner-shade"/><div className="company-heading"><div className="eyebrow">{item.date}</div><h3>{item.company}<span>{item.role}</span></h3><p>{item.headline}</p><span className="company-fullname">{item.fullName}</span></div>{index===1&&<div className="baidu-visual"><a className="baidu-browser-preview" href="https://hanyu.baidu.com/hanyu-page/zici/s?wd=%E5%B1%B1&amp;ptype=zici" target="_blank" rel="noreferrer" aria-label="查看百度汉语公开页面"><div className="baidu-browser-bar"><span aria-hidden="true">● ● ●</span><span>hanyu.baidu.com</span></div><img src="/images/baidu-hanyu-real.webp" alt="百度汉语当前公开页面：山的字形、拼音、释义和例句" width="1400" height="875" loading="lazy" decoding="async"/></a></div>}</div>

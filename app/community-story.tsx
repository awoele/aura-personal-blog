...
export default function CommunityStory() {
  return <section className="community-story" aria-labelledby="community-title" data-reveal>
    <div className="community-copy">
      ...
      <div className="community-cat-gallery" aria-label="五个小猫头像占位，等待真实照片">
        <div className="community-cat-portraits" aria-hidden="true">{Array.from({length:5},(_,index)=><span className="community-cat-placeholder" key={index}><Cat strokeWidth={1}/></span>)}</div>
        <p>小猫相册 <span>· 照片待补充</span></p>
      </div>
    </div>
